package com.minatogithuborganization.cloudrunaug18one;
...
@SpringBootApplication(scanBasePackages = {"com.vs.rappit","com.vs","com.minatogithuborganization.cloudrunaug18one"})
@EnableCaching
...
public class Cloudrunaug18oneApplication {

	public static void main(String[] args) {
		SpringApplication.run(Cloudrunaug18oneApplication.class, args);
	}
