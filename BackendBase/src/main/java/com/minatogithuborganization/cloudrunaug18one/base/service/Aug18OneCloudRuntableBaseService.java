...
public class Aug18OneCloudRuntableBaseService<T extends Aug18OneCloudRuntableBase> extends BaseBusinessLogic<T>
		implements IAug18OneCloudRuntableBaseService<T> {
	...
	@Autowired
	private  Aug18OneCloudRuntablePerimeterBaseImpl aug18onecloudruntablePerimeterBaseImpl;
	
	public Aug18OneCloudRuntableBaseService(Class<T> modelClass) {
		super(modelClass);
	...
	public void onAfterSaveDB(T modelObj) {
	  changelogService.createChangeLog("Aug18OneCloudRuntable", modelObj.getSid(), Constants.SAVED, modelObj);
	}
	...
	public void onAfterUpdateDB(T modelObj) {
	  changelogService.createChangeLog("Aug18OneCloudRuntable", modelObj.getSid(), Constants.UPDATED, modelObj);
	}
	...
	public void onAfterDeleteDB(T modelObj) {
	  changelogService.createChangeLog("Aug18OneCloudRuntable", modelObj.getSid(), Constants.DELETED, modelObj);
	}	
	...
	protected IPerimeterManager<T> getPerimeterManager() {
		return aug18onecloudruntablePerimeterBaseImpl;
	}
}